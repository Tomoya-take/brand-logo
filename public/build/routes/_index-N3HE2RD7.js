...
var require_session_token = __commonJS({
  "node_modules/@shopify/app-bridge-utils/utilities/session-token/session-token.js"(exports) {
    ...
    var Error_1 = require_Error2();
    function getSessionToken2(appBridge) {
      return __awaiter(this, void 0, void 0, function() {
        return __generator(this, function(_a) {
    ...
    exports.getSessionToken = getSessionToken2;
  }
});
...
var require_authenticated_fetch = __commonJS({
  "node_modules/@shopify/app-bridge-utils/utilities/session-token/authenticated-fetch.js"(exports) {
    ...
    function authenticatedFetch2(app, fetchOperation) {
      var _this = this;
    ...
    exports.authenticatedFetch = authenticatedFetch2;
  }
});
...
var import_app_bridge_utils = __toESM(require_app_bridge_utils());
if (import.meta) {
  import.meta.hot = createHotContext(
    //@ts-expect-error
    "app\\utils\\authenticatedFetch.js"
  );
  import.meta.hot.lastModified = "1755611688848.829";
}
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1755620987014.488";
}
function Index() {
  _s();
  const [shop, setShop] = (0, import_react.useState)(null);
  (0, import_react.useEffect)(() => {
    const host = window.__SHOPIFY_HOST__ || new URLSearchParams(window.location.search).get("host") || "";
    const apiKey = window.__SHOPIFY_API_KEY__ || "";
    if (!host) {
      console.error("\u274C host \u304C\u6307\u5B9A\u3055\u308C\u3066\u3044\u307E\u305B\u3093");
      return;
    }
    const app = (0, import_app_bridge.createApp)({
      apiKey,
      host,
      forceRedirect: true
    });
    const fetchWithAuth = authenticatedFetch(app);
    fetchWithAuth("/api/test").then((res) => res.json()).then((data) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { style: {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("h1", { children: "Brand Logo List App" }, void 0, false, {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("strong", { children: "Add Section \u2192 Apps \u2192 Brand Logo List App" }, void 0, false, {
        fileName: "app/routes/_index.tsx",
        lineNumber: 58,
        columnNumber: 37
      }, this),
    ...
    shop && /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { style: {
      marginTop: "1rem",
      color: "green"
    }, children: [
      "\u2705 Connected to shop: ",
...
_s(Index, "8f6C0oXVboepx2554EcUa2l48Xk=");
_c = Index;
var _c;
$RefreshReg$(_c, "Index");
...
//# sourceMappingURL=/build/routes/_index-N3HE2RD7.js.map
